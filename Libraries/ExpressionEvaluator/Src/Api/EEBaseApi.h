...
namespace ee {
	...
	public :
		...
		virtual CExpEvalContainer::EE_RESULT					Ascii() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the binary form of the object as a string (0b****).
		virtual CExpEvalContainer::EE_RESULT					Bin() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the boolean form of the object as a string (0b****).
		virtual CExpEvalContainer::EE_RESULT					Bool() const EE_PURE { return { EE_NC_INVALID }; }

		// Returns the character that represents the specified Unicode. 
		virtual CExpEvalContainer::EE_RESULT					Chr() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the string interpreted to its best fit and then converted to float. 
		virtual CExpEvalContainer::EE_RESULT					Float() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the hexadecimal form of the object as a string (0x****).
		virtual CExpEvalContainer::EE_RESULT					Hex() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the string interpreted to its best fit and then converted to int64_t. 
		virtual CExpEvalContainer::EE_RESULT					Int() const EE_PURE { return { EE_NC_INVALID }; }
		...
		virtual CExpEvalContainer::EE_RESULT					Len() const EE_PURE { return { EE_NC_INVALID }; }

		// Gets the octadecimal form of the object as a string (0o****).
		virtual CExpEvalContainer::EE_RESULT					Oct() const EE_PURE { return { EE_NC_INVALID }; }

		// Returns the ordinal value of the object as a Unicode character (always EE_NC_UNSIGNED).
		virtual CExpEvalContainer::EE_RESULT					Ord() const EE_PURE { return { EE_NC_INVALID }; }
