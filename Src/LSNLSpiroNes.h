...
namespace lsn {
	...
	enum LSN_CLOCK_SPEEDS : uint64_t {
		 ...
		 * NTSC-M Signal Hz:		3579545.4545454545454545454545455.	(4500000.0 / 286.0) * (455.0 / 2.0)
		 * PAL-M Signal Hz:			3575611.8881118881118881118881119.	(4500000.0 / 286.0) * (909.0 / 4.0)
		 * PAL-B Signal Hz:			4433618.75.							((1135.0 / 4.0) * 15625.0) + 25.0
		 * PAL-I Signal Hz:			4433618.75.							((1135.0 / 4.0) * 15625.0) + 25.0
		 * PAL-N Signal Hz:			3582056.25.							((917.0 / 4.0) * 15625.0) + 25.0
		 */
	};
	...
	enum LSN_IRQ_SOURCE {
		...
		LSN_IS_MAPPER						= (1 << 4),							/**< Depends on specific IC. */
