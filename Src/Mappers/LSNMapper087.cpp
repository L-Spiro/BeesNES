...
#include "LSNMapper087.h"


namespace lsn {

	CMapper087::CMapper087() {
	}
	CMapper087::~CMapper087() {
	}
	 ...
	 */
	void CMapper087::InitWithRom( LSN_ROM &_rRom ) {
	 ...
	 */
	void CMapper087::ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
	 ...
	 */
	void LSN_FASTCALL CMapper087::SelectBank6000_7FFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
