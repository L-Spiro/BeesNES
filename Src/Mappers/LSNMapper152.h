 ...
 *
 * Description: Mapper 152 implementation.
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper152
	 * \brief Mapper 152 implementation.
	 *
	 * Description: Mapper 152 implementation.
	 */
	class CMapper152 : public CMapperBase {
	public :
		CMapper152() {
		}
		virtual ~CMapper152() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x8000; I < 0x10000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper152::SelectBank8000_BFFF, this, uint16_t( I ) );
			}
	...
	protected :
		...
		static void LSN_FASTCALL						SelectBank8000_BFFF( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper152 * pmThis = reinterpret_cast<CMapper152 *>(_pvParm0);
			...
			pmThis->SetPgmBank<0, PgmBankSize()>( (_ui8Val >> 4) & 0b0111 );
