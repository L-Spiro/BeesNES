 ...
 *
 * Description: Mapper 038 implementation.
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper038
	 * \brief Mapper 038 implementation.
	 *
	 * Description: Mapper 038 implementation.
	 */
	class CMapper038 : public CMapperBase {
	public :
		CMapper038() {
		}
		virtual ~CMapper038() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x7000; I < 0x8000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper038::SelectBank7000_7FFF, this, 0 );	// Treated as ROM.
			}
		}
	...
	protected :
		 ...
		 */
		static void LSN_FASTCALL						SelectBank7000_7FFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper038 * pmThis = reinterpret_cast<CMapper038 *>(_pvParm0);
			pmThis->SetPgmBank<0, PgmBankSize()>( _ui8Val & 0b0011 );
			pmThis->SetChrBank<0, ChrBankSize()>( (_ui8Val & 0b1100) >> 2 );
		}
	};
