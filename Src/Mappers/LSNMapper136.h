 ...
 *
 * Description: Mapper 136 implementation.
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper136
	 * \brief Mapper 136 implementation.
	 *
	 * Description: Mapper 136 implementation.
	 */
	class CMapper136 : public CMapperBase {
	public :
		CMapper136() {
		}
		virtual ~CMapper136() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x8000; I < 0x10000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper136::SelectBankY000_YFFF, this, 0 );	// Treated as ROM.
			}
	...
	protected :
		...
		static void LSN_FASTCALL						SelectBankY000_YFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper136 * pmThis = reinterpret_cast<CMapper136 *>(_pvParm0);
