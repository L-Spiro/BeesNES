 ...
 *
 * Description: Mapper 068 implementation.
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper068
	 * \brief Mapper 068 implementation.
	 *
	 * Description: Mapper 068 implementation.
	 */
	class CMapper068 : public CMapperBase {
	public :
		CMapper068() {
		}
		virtual ~CMapper068() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x8000; I < 0x10000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper068::SelectBankY000_YFFF, this, 0 );	// Treated as ROM.
			}
	...
	protected :
		...
		static void LSN_FASTCALL						SelectBankY000_YFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper068 * pmThis = reinterpret_cast<CMapper068 *>(_pvParm0);
