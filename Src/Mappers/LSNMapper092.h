 ...
 *
 * Description: Mapper 092 implementation (relative of Mapper 072).
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper092
	 * \brief Mapper 092 implementation (relative of Mapper 072).
	 *
	 * Description: Mapper 092 implementation (relative of Mapper 072).
	 */
	class CMapper092 : public CMapperBase {
	public :
		CMapper092() {
		}
		virtual ~CMapper092() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x8000; I < 0x10000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper092::SelectBank8000_FFFF, this, 0 );	// Treated as ROM.
			}
		}
	...
	protected :
		...
		static void LSN_FASTCALL						SelectBank8000_FFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper092 * pmThis = reinterpret_cast<CMapper092 *>(_pvParm0);
