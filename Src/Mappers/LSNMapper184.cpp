...
#include "LSNMapper184.h"


namespace lsn {

	CMapper184::CMapper184() {
	}
	CMapper184::~CMapper184() {
	}
	 ...
	 */
	void CMapper184::InitWithRom( LSN_ROM &_rRom ) {
	 ...
	 */
	void CMapper184::ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
	 ...
	 */
	void LSN_FASTCALL CMapper184::ChrBank1Read_1000( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t &_ui8Ret ) {
	 ...
	 */
	void LSN_FASTCALL CMapper184::SelectBank6000_7FFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper184 * pmThis = reinterpret_cast<CMapper184 *>(_pvParm0);
