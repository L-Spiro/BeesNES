...
#include "LSNMapper009.h"


namespace lsn {

	CMapper009::CMapper009() {
	}
	CMapper009::~CMapper009() {
	}
	 ...
	 */
	void CMapper009::InitWithRom( LSN_ROM &_rRom ) {
	 ...
	 */
	void CMapper009::ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
		// ================
		// FIXED BANKS
		// ================
	 ...
	 */
	void LSN_FASTCALL CMapper009::Mapper009PgmRamRead( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t &_ui8Ret ) {
	 ...
	 */
	void LSN_FASTCALL CMapper009::Mapper009PgmRamWrite( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::Mapper009ChrBankRead_0000_0FFF( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t &_ui8Ret ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::Mapper009ChrBankRead_1000_1FFF( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t &_ui8Ret ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SelectBankA000_AFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SelectBankB000_BFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SelectBankC000_CFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SelectBankD000_DFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SelectBankE000_EFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The value to write.
	 */
	void LSN_FASTCALL CMapper009::SetMirroringF000_FFFF( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
		CMapper009 * pmThis = reinterpret_cast<CMapper009 *>(_pvParm0);
		/*
		 *	7  bit  0
		 *	---- ----
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::SetLatch_0FD8_Trampoline( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * _pui8Data, uint8_t &_ui8Ret ) {
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::SetLatch_0FE8_Trampoline( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * _pui8Data, uint8_t &_ui8Ret ) {
		CCpuBus::LSN_TRAMPOLINE * ptTramp = reinterpret_cast<CCpuBus::LSN_TRAMPOLINE *>(_pvParm0);
		CMapper009 * pmBase = reinterpret_cast<CMapper009 *>(ptTramp->pvReaderParm0);
		ptTramp->aaOriginalFuncs.pfReader( ptTramp->aaOriginalFuncs.pvReaderParm0,
			ptTramp->aaOriginalFuncs.ui16ReaderParm1,
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::SetLatch_1FD8_1FDF_Trampoline( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * _pui8Data, uint8_t &_ui8Ret ) {
		CCpuBus::LSN_TRAMPOLINE * ptTramp = reinterpret_cast<CCpuBus::LSN_TRAMPOLINE *>(_pvParm0);
		CMapper009 * pmBase = reinterpret_cast<CMapper009 *>(ptTramp->pvReaderParm0);
		ptTramp->aaOriginalFuncs.pfReader( ptTramp->aaOriginalFuncs.pvReaderParm0,
			ptTramp->aaOriginalFuncs.ui16ReaderParm1,
	 ...
	 * \param _ui8Ret The read value.
	 */
	void LSN_FASTCALL CMapper009::SetLatch_1FE8_1FEF_Trampoline( void * _pvParm0, uint16_t /*_ui16Parm1*/, uint8_t * _pui8Data, uint8_t &_ui8Ret ) {
		CCpuBus::LSN_TRAMPOLINE * ptTramp = reinterpret_cast<CCpuBus::LSN_TRAMPOLINE *>(_pvParm0);
		CMapper009 * pmBase = reinterpret_cast<CMapper009 *>(ptTramp->pvReaderParm0);
		ptTramp->aaOriginalFuncs.pfReader( ptTramp->aaOriginalFuncs.pvReaderParm0,
			ptTramp->aaOriginalFuncs.ui16ReaderParm1,
