 ...
 *
 * Description: Mapper 070 implementation.
 */
...
namespace lsn {
	...
	/**
	 * Class CMapper070
	 * \brief Mapper 070 implementation.
	 *
	 * Description: Mapper 070 implementation.
	 */
	class CMapper070 : public CMapperBase {
	public :
		CMapper070() {
		}
		virtual ~CMapper070() {
		...
		virtual void									ApplyMap( CCpuBus * _pbCpuBus, CPpuBus * _pbPpuBus ) {
			...
			for ( uint32_t I = 0x8000; I < 0x10000; ++I ) {
				_pbCpuBus->SetWriteFunc( uint16_t( I ), &CMapper070::SelectBank8000_BFFF, this, uint16_t( I ) );
			}
	...
	protected :
		...
		static void LSN_FASTCALL						SelectBank8000_BFFF( void * _pvParm0, uint16_t _ui16Parm1, uint8_t * /*_pui8Data*/, uint8_t _ui8Val ) {
			CMapper070 * pmThis = reinterpret_cast<CMapper070 *>(_pvParm0);
