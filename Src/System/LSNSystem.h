...
namespace lsn {
	...
	typedef CSystem<LSN_CS_PALN_MASTER, LSN_CS_PALN_MASTER_DIVISOR,
		...
		CCpu6502, CPalMPpu, CApu2A0X<LSN_APU_TYPE( NTSC ), LSN_CS_PALN_MASTER, LSN_CS_PALN_MASTER_DIVISOR, LSN_CS_PALN_APU_DIVISOR>>
																							CPalMSystem;
	...
	typedef CSystem<LSN_CS_PALN_MASTER, LSN_CS_PALN_MASTER_DIVISOR,
		LSN_CS_PALN_CPU_DIVISOR, LSN_CS_PALN_PPU_DIVISOR, LSN_CS_PALN_APU_DIVISOR,
		CCpu6502, CPalNPpu, CApu2A0X<LSN_APU_TYPE( NTSC ), LSN_CS_PALN_MASTER, LSN_CS_PALN_MASTER_DIVISOR, LSN_CS_PALN_APU_DIVISOR>>
																							CPalNSystem;
