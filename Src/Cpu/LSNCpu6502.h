...
namespace lsn {
	...
	protected :
		...
		void								FetchAddressAndIncPc_Zpg();						// Cycle 2.
		...
		/** Reads from the effective address.  The address is in LSN_CPU_CONTEXT::a.ui16Address.  The result is stored in LSN_CPU_CONTEXT::ui8Operand. */
		void								ReadFromEffectiveAddress_Zpg();					// Cycles 2, 4.
		...
		void								FetchEffectiveAddressLow_IndX();				// Cycle 4.
		...
		void								FetchEffectiveAddressHigh_IndX();				// Cycle 5.
		...
		void								FetchEffectiveAddressLow_IndY();				// Cycle 3.
		...
		void								FetchEffectiveAddressHigh_IndY();				// Cycle 4.
		 ...
		 * Chain:
		 *	FetchOpcodeAndIncPc() (implicit.)
		 *	FetchEffectiveAddressLow_IndY()
		 *	FetchEffectiveAddressHigh_IndY()
