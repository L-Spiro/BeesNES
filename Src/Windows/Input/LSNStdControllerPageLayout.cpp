	...
	LSW_WIDGET_LAYOUT CStdControllerPageLayout::m_wlPage[] = {
		{
			...
			CWinUtilities::LSN_SCPI_MAINWINDOW,		// wId
			nullptr,								// lpwcClass
			TRUE,									// bEnabled
			FALSE,									// bActive
			0,										// iLeft
			...
			nullptr,								// pwcText
			0,										// sTextLen
			CWinUtilities::LSN_SCPI_NONE,				// dwParentId
		},
#define LSN_QUICK_CONTR( TYPE_, ID_, TEXT_, X_, Y_, W_, H_, STYLE_, STYLEEX_ )																		\
	{																																				\
		...
		TEXT_,																																		\
		0,																																			\
		CWinUtilities::LSN_SCPI_MAINWINDOW,																											\
	},


#define LSN_QUICK_BUTTON( BUTTON_, TEXT_, X_, Y_ )																																								\
	LSN_QUICK_CONTR( LSW_LT_GROUPBOX, BUTTON_ + CWinUtilities::LSN_SCPI_GROUP, TEXT_, (X_), (Y_),																												\
	...
	LSN_QUICK_CONTR( LSW_LT_LABEL, BUTTON_ + CWinUtilities::LSN_SCPI_LABEL, LSN_LSTR( LSN_BUTTON_ ), (X_) + LSN_GROUP_LEFT, (Y_) + LSN_GROUP_TOP + (LSN_DEF_BUTTON_HEIGHT - LSN_DEF_STATIC_HEIGHT) / 2,			\
		LSN_STD_CONT_BUTTON_LABEL_W, LSN_DEF_STATIC_HEIGHT, LSN_STATICSTYLE, 0 )																																\
	LSN_QUICK_CONTR( LSW_LT_BUTTON, BUTTON_ + CWinUtilities::LSN_SCPI_BUTTON, nullptr,																															\
	...
	LSN_QUICK_CONTR( LSW_LT_LABEL, BUTTON_ + CWinUtilities::LSN_SCPI_TURBO_LABEL, LSN_LSTR( LSN_TURBO_ ),																										\
		(X_) + LSN_GROUP_LEFT, (Y_) + LSN_GROUP_TOP + (LSN_DEF_BUTTON_HEIGHT - LSN_DEF_STATIC_HEIGHT) / 2 + LSN_DEF_BUTTON_HEIGHT + 1,																			\
		LSN_STD_CONT_BUTTON_LABEL_W, LSN_DEF_STATIC_HEIGHT, LSN_STATICSTYLE, 0 )																																\
	LSN_QUICK_CONTR( LSW_LT_BUTTON, BUTTON_ + CWinUtilities::LSN_SCPI_TURBO_BUTTON, nullptr,																													\
		(X_) + LSN_GROUP_LEFT + LSN_STD_CONT_BUTTON_LABEL_W, (Y_) + LSN_GROUP_TOP + LSN_DEF_BUTTON_HEIGHT + 1,																									\
		LSN_STD_CONT_BUTTON_BUTTON_W, LSN_DEF_BUTTON_HEIGHT, LSN_BUTTONSTYLE, WS_EX_LEFT | WS_EX_LTRREADING | WS_EX_RIGHTSCROLLBAR | WS_EX_NOPARENTNOTIFY )														\
	LSN_QUICK_CONTR( LSW_LT_COMBOBOX, BUTTON_ + CWinUtilities::LSN_SCPI_TURBO_COMBO, nullptr,																													\
	...
	LSN_QUICK_CONTR( LSW_LT_LABEL, BUTTON_ + CWinUtilities::LSN_SCPI_TURBO_DEADZONE_LABEL, LSN_LSTR( LSN_DEAD_ ),																								\
		...
		LSN_STD_CONT_BUTTON_LABEL_W, LSN_DEF_STATIC_HEIGHT, LSN_STATICSTYLE, 0 )																																\
	LSN_QUICK_CONTR( LSW_LT_TRACKBAR, BUTTON_ + CWinUtilities::LSN_SCPI_TURBO_DEADZONE_TRACKBAR, nullptr,																										\
		...
		// Buttons.
		LSN_QUICK_CONTR( LSW_LT_GROUPBOX, CWinUtilities::LSN_SCPI_DPAD_GROUP, LSN_LSTR( LSN_DIRECTIONAL_PAD ), LSN_STD_CONT_DPAD_LEFT, LSN_STD_CONT_DPAD_TOP,
		...
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_UP_START, LSN_LSTR( LSN_BUTTON_UP ), LSN_STD_CONT_DPAD_LEFT + LSN_STD_CONT_DPAD_H_MIDDLE - LSN_STD_CONT_BUTTON_GROUP_W / 2 + LSN_GROUP_LEFT,
			LSN_STD_CONT_DPAD_TOP + LSN_GROUP_TOP )
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_LEFT_START, LSN_LSTR( LSN_BUTTON_LEFT ), LSN_STD_CONT_DPAD_LEFT + LSN_GROUP_LEFT,
			LSN_STD_CONT_DPAD_TOP + LSN_STD_CONT_DPAD_V_MIDDLE - LSN_STD_CONT_BUTTON_GROUP_H / 2 + LSN_GROUP_TOP )
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_RIGHT_START, LSN_LSTR( LSN_BUTTON_RIGHT ), LSN_STD_CONT_DPAD_LEFT + LSN_STD_CONT_DPAD_W - LSN_STD_CONT_BUTTON_GROUP_W + LSN_GROUP_LEFT,
			LSN_STD_CONT_DPAD_TOP + LSN_STD_CONT_DPAD_V_MIDDLE - LSN_STD_CONT_BUTTON_GROUP_H / 2 + LSN_GROUP_TOP )
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_DOWN_START, LSN_LSTR( LSN_BUTTON_DOWN ), LSN_STD_CONT_DPAD_LEFT + LSN_STD_CONT_DPAD_H_MIDDLE - LSN_STD_CONT_BUTTON_GROUP_W / 2 + LSN_GROUP_LEFT,
			LSN_STD_CONT_DPAD_TOP + LSN_STD_CONT_DPAD_H - LSN_STD_CONT_BUTTON_GROUP_H + LSN_GROUP_TOP )

		LSN_QUICK_CONTR( LSW_LT_GROUPBOX, CWinUtilities::LSN_SCPI_SS_GROUP, LSN_LSTR( LSN_SELECT_START ), LSN_STD_CONT_SS_LEFT, LSN_STD_CONT_SS_TOP,
		...
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_SELECT_START, LSN_LSTR( LSN_BUTTON_SELECT ), LSN_STD_CONT_SS_LEFT + LSN_GROUP_LEFT,
			LSN_STD_CONT_SS_TOP + LSN_GROUP_TOP )
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_START_START, LSN_LSTR( LSN_BUTTON_START ), LSN_STD_CONT_SS_LEFT + LSN_GROUP_LEFT + LSN_STD_CONT_SS_START_LEFT,
			LSN_STD_CONT_SS_TOP + LSN_GROUP_TOP )

		LSN_QUICK_CONTR( LSW_LT_GROUPBOX, CWinUtilities::LSN_SCPI_BUTTON_GROUP, LSN_LSTR( LSN_BUTTONS ), LSN_STD_CONT_BUT_LEFT, LSN_STD_CONT_BUT_TOP,
		...
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_B_START, LSN_LSTR( LSN_BUTTON_B ), LSN_STD_CONT_BUT_LEFT + LSN_GROUP_LEFT,
			LSN_STD_CONT_BUT_TOP + LSN_GROUP_TOP )
		LSN_QUICK_BUTTON( CWinUtilities::LSN_SCPI_BUTTON_A_START, LSN_LSTR( LSN_BUTTON_A ), LSN_STD_CONT_BUT_LEFT + LSN_GROUP_LEFT + LSN_STD_CONT_BUT_A_LEFT,
			LSN_STD_CONT_BUT_TOP + LSN_GROUP_TOP )
...
#undef LSN_QUICK_CONTR
		...
		// Input Devices.
		{
			...
			CWinUtilities::LSN_SCPI_INPUT_DEVICES_GROUP,		// wId
			...
			0,												// sTextLen
			CWinUtilities::LSN_SCPI_MAINWINDOW,				// dwParentId
		},
		{
			LSW_LT_LISTVIEW,								// ltType
			CWinUtilities::LSN_SCPI_INPUT_DEVICES_LISTVIEW,	// wId
			nullptr,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
		...
		{
			LSW_LT_RADIO,									// ltType
			CWinUtilities::LSN_SCPI_INPUT_DPAD_DOT,			// wId
			WC_BUTTONW,										// lpwcClass
			FALSE,											// bEnabled
			TRUE,											// bActive
		...
		{
			LSW_LT_GROUPBOX,								// ltType
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_GROUP,	// wId
			WC_BUTTONW,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
		...
		},
		{
			...
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_SET_ALL_BUTTON,		// wId
			WC_BUTTONW,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
		...
		{
			LSW_LT_BUTTON,									// ltType
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_SET_TURBO_BUTTON,		// wId
			WC_BUTTONW,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
			LSN_STD_CONT_QUICK_GROUP_LEFT + LSN_GROUP_LEFT,	// iLeft
		...
		{
			LSW_LT_LABEL,									// ltType
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_DASH_LABEL,// wId
			nullptr,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
			LSN_STD_CONT_QUICK_GROUP_LEFT + LSN_GROUP_LEFT,	// iLeft
		...
		{
			LSW_LT_BUTTON,									// ltType
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_CLEAR_ALL_BUTTON,		// wId
			WC_BUTTONW,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
			LSN_STD_CONT_QUICK_GROUP_LEFT + LSN_GROUP_LEFT,	// iLeft
		...
		{
			LSW_LT_GROUPBOX,								// ltType
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_PRESET_GROUP,// wId
			WC_BUTTONW,										// lpwcClass
			TRUE,											// bEnabled
			FALSE,											// bActive
		...
		},
		{
			...
			CWinUtilities::LSN_SCPI_QUICK_CONFIGURE_PRESET_COMBO,// wId
