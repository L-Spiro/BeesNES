...
namespace lsn {
	...
	LSW_MENU_ITEM CMainWindowLayout::m_miVideoSizeMenu[] = {
		//bIsSeperator	dwId												bCheckable	bChecked	bEnabled	lpwcText
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_1X,								TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_1X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_1_75X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_1_75X ) },
		...
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_3_5X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_3_5X ) },
		...
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_5_25X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_5_25X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_6X,								TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_6X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_7X,								TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_7X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_8X,								TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_8X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_8_75X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_8_75X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_9X,								TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_9X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_10X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_10X ) },
		{ FALSE,		LSN_MWMI_VIDEO_SIZE_10_5X,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_SIZE_10_5X ) },
	};
...
#ifdef LSN_DX9
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_DIRECT3D_9 ) },
#endif	// #ifdef LSN_DX9
#ifdef LSN_DX12
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12,							TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_DIRECT3D_12 ) },
#endif	// #ifdef LSN_DX12
#ifdef LSN_VULKAN1
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN,						TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_VULKAN_1 ) },
#endif	// #ifdef LSN_VULKAN1
	};

#ifdef LSN_DX9
	/** Video-filter/Direct3D 9 sub-menu. */
	LSW_MENU_ITEM CMainWindowLayout::m_miDx9FilterMenu[] = {
		//bIsSeperator	dwId												bCheckable	bChecked	bEnabled	lpwcText
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_PALETTE,					TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_DX9_PALETTE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_NTSC_BLARGG_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_BLARGG_DX9_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_NTSC_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_NTSC_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_PAL_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PAL_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_DENDY_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_DENDY_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_PALM_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALM_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_PALN_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALN_DX9_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_NTSC_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_CRT_FULL_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_PAL_CRT_FULL,				TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_PAL_CRT_FULL_DX9_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_AUTO_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_CRT_FULL_DX9_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX9_AUTO_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_LSPIRO_DX9_UPSCALE ) },
	};
#endif	// #ifdef LSN_DX9

#ifdef LSN_DX12
	/** Video-filter/Direct3D 12 sub-menu. */
	LSW_MENU_ITEM CMainWindowLayout::m_miDx12FilterMenu[] = {
		//bIsSeperator	dwId												bCheckable	bChecked	bEnabled	lpwcText
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_PALETTE,					TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_DX12_PALETTE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_NTSC_BLARGG_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_BLARGG_DX12_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_NTSC_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_NTSC_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_PAL_LSPIRO_UPSCALED,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PAL_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_DENDY_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_DENDY_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_PALM_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALM_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_PALN_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALN_DX12_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_NTSC_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_CRT_FULL_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_PAL_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_PAL_CRT_FULL_DX12_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_AUTO_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_CRT_FULL_DX12_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_DX12_AUTO_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_LSPIRO_DX12_UPSCALE ) },
	};
#endif	// #ifdef LSN_DX12

#ifdef LSN_VULKAN1
		/** Video-filter/Vulkan 1 sub-menu. */
		LSW_MENU_ITEM CMainWindowLayout::m_miVulkan1FilterMenu[] = {
		//bIsSeperator	dwId												bCheckable	bChecked	bEnabled	lpwcText
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_PALETTE,				TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_VULKAN_PALETTE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_NTSC_BLARGG_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_BLARGG_VULKAN_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_NTSC_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_NTSC_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_PAL_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PAL_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_DENDY_LSPIRO_UPSCALED,TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_DENDY_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_PALM_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALM_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_PALN_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALN_VULKAN_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_NTSC_CRT_FULL,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_NTSC_CRT_FULL_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_PAL_CRT_FULL,			TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_PAL_CRT_FULL_VULKAN_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_AUTO_CRT_FULL,		TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_CRT_FULL_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN1_AUTO_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_LSPIRO_VULKAN_UPSCALE ) },
	};
#endif	// #ifdef LSN_VULKAN1
...
#ifdef LSN_DX9
		{
			LSN_MWMI_VIDEO_DX9_MENU,
			LSN_MWMI_VIDEO_FILTERS,
			LSN_MWMI_VIDEO_FILTER_DX9,
			std::size( m_miDx9FilterMenu ),
			m_miDx9FilterMenu
		},
#endif	// #ifdef LSN_DX9
#ifdef LSN_DX12
		{
			LSN_MWMI_VIDEO_DX12_MENU,
			LSN_MWMI_VIDEO_FILTERS,
			LSN_MWMI_VIDEO_FILTER_DX12,
			std::size( m_miDx12FilterMenu ),
			m_miDx12FilterMenu
		},
#endif	// #ifdef LSN_DX12
#ifdef LSN_VULKAN1
		{
			LSN_MWMI_VIDEO_VULKAN_MENU,
			LSN_MWMI_VIDEO_FILTERS,
			LSN_MWMI_VIDEO_FILTER_VULKAN,
			std::size( m_miVulkan1FilterMenu ),
			m_miVulkan1FilterMenu
		},
#endif	// #ifdef LSN_VULKAN1
		// Regions.
		{
