...
//#endif	// #ifdef LSN_VULKAN1
	...
	LSW_MENU_ITEM CMainWindowLayout::m_miDx12FilterMenu[] = {
		...
		//bIsSeperator	dwId												bCheckable	bChecked	bEnabled	lpwcText
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_PALETTE,				TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_VULKAN_PALETTE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_NTSC_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_NTSC_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_PAL_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PAL_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_DENDY_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_DENDY_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_PALM_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALM_VULKAN_UPSCALE ) },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_PALN_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_LSPIRO_PALN_VULKAN_UPSCALE ) },
		{ TRUE,			0,													FALSE,		FALSE,		TRUE,		nullptr },
		{ FALSE,		LSN_MWMI_VIDEO_FILTER_VULKAN_AUTO_LSPIRO_UPSCALED,	TRUE,		FALSE,		TRUE,		LSN_LSTR( LSN_VIDEO_FILTER_AUTO_LSPIRO_VULKAN_UPSCALE ) },
	};
#endif	// #ifdef LSN_VULKAN1
