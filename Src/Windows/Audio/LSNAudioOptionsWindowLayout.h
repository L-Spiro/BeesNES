...
namespace lsn {
	...
	public :
		...
		enum LSN_AUDIO_OPTIONS_WINDOW_IDS : WORD {
			...
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_GROUP,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_PRESETS_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_PRESETS_COMBO,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_LPF_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_LPF_EDIT,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_LPF_CHECK,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF0_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF0_EDIT,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF0_CHECK,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF1_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF1_EDIT,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF1_CHECK,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF2_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF2_EDIT,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_HPF2_CHECK,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_VOLUME_LABEL,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_VOLUME_TRACKBAR,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_VOLUME_EDIT,

			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_INVERT_CHECK,
			LSN_AOWI_PAGE_GENERAL_CHARACTERISTICS_NOISE_CHECK,
		};
