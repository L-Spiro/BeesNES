...
#define LSN_AUDIO_OPTIONS_CHAR_GROUP_H						(LSN_GROUP_TOP_PXL + LSN_GROUP_BOTTOM_PXL + (LSN_DEF_COMBO_HEIGHT) + (LSN_DEF_EDIT_HEIGHT + LSN_TOP_JUST) + (LSN_DEF_EDIT_HEIGHT + LSN_TOP_JUST) * 3 + (LSN_TOP_JUST * 2))
