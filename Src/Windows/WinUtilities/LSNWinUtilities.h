...
namespace lsn {
	...
	public :
		...
		enum LSN_CONTROL_IDS : WORD {
			...
			LSN_CWI_EDIT_BUTTON,
			LSN_CWI_FILTER_BUTTON,
			LSN_CWI_SEARCH_BUTTON,
			LSN_CWI_FILTER_BUTTON_PLACHOLDER,
			LSN_CWI_SEARCH_BUTTON_PLACHOLDER,

			LSN_CWI_GROUP,
			LSN_CWI_CHEAT_TREELISTVIEW,
			LSN_CWI_CODE_EDIT,
			LSN_CWI_NOTES_EDIT,
			LSN_CWI_ACTIVATE_BUTTON,
			LSN_CWI_ACTIVATE_WITH_HOTKEY_BUTTON,
			LSN_CWI_OK,
			LSN_CWI_CANCEL,

			// == Context Menu == //
			LSN_CWI_SHOW_ENABLED,
			LSN_CWI_SELECT_ENABLED,
			LSN_CWI_EXPAND_SELECTED,
			LSN_CWI_EXPAND_ALL,
			LSN_CWI_COLLAPSE_SELECTED,
			LSN_CWI_COLLAPSE_ALL,
		};
#endif	// #if defined( LSN_WINDOWS )
