...
#define LSN_SECTION_W									200
#define LSN_CHEAT_GROUP_W								(LSN_LEFT_JUST + LSN_SECTION_W + LSN_LEFT_JUST + LSN_SECTION_W + LSN_LEFT_JUST)
#define LSN_CHEAT_GROUP_H								(50 + 100 + 20)
