...
namespace lsn {
	...
	// == Members.
	/** The length table. */
	const uint8_t CApuUnit::m_ui8LenTable[32] = {
		10,254, 20,  2, 40,  4, 80,  6, 160,  8, 60, 10, 14, 12, 26, 14,
		12, 16, 24, 18, 48, 20, 96, 22, 192, 24, 72, 26, 16, 28, 32, 30
	};

	/** The noise periods for NTSC and PAL. */
	const uint16_t CApuUnit::m_ui16NoisePeriods[LSN_AT_TOTAL][0x10] = {
	...
	const uint16_t CApuUnit::m_ui16NoisePeriodsOld[LSN_AT_TOTAL][0x10] = {
