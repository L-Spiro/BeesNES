...
/**
 * Modified by L. Spiro					27/12/2022
 *	Removed following compiler warnings:
 *		warning C4127: conditional expression is constant
 *			via #pragma warning( disable : 4127 )
 *		warning C4456: declaration of 'n' hides previous local declaration
 *			via changing the name of 'n'.
 *		warning C4457: declaration of 'i' hides function parameter
 *			via changing the name of 'i'.
 *		warning C4457: declaration of 'q' hides function parameter
 *			via changing the name of 'q'.
 *		warning C4457: declaration of 'y' hides function parameter
 *			via changing the name of 'y'.
 */
...
static void gen_kernel( init_t* impl, float y, float i, float q, nes_ntsc_rgb_t* out )
{
	...
	do
	{
		...
		do
		{
			...
			{
				float i2 = k[0]*ic0 + k[2]*ic2;
				float q2 = k[1]*qc1 + k[3]*qc3;
				float y2 = k[kernel_size+0]*yc0 + k[kernel_size+1]*yc1 +
				...
				{
					int r, g, b = YIQ_TO_RGB( y2, i2, q2, to_rgb, int, r, g );
