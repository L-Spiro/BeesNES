...
namespace lsn {
	...
	CNesPalette::Float64_3 CNesPalette::UpdateEntry( const Float64_3 &_fEntry, LSN_GAMMA _gCrtGamma, LSN_GAMMA _gMonitorGamma ) {
		...
		switch ( _gCrtGamma ) {
			...
			case LSN_G_POW_1_96 : {
				fDst.x[0] = std::pow( _fEntry.x[0], 1.95999999999999996447286321199499070644378662109375 );
				fDst.x[1] = std::pow( _fEntry.x[1], 1.95999999999999996447286321199499070644378662109375 );
				fDst.x[2] = std::pow( _fEntry.x[2], 1.95999999999999996447286321199499070644378662109375 );
				break;
			}
			case LSN_G_POW_2_0 : {
			...
			case LSN_G_POW_2_35 : {
				fDst.x[0] = std::pow( _fEntry.x[0], 2.350000000000000088817841970012523233890533447265625 );
				fDst.x[1] = std::pow( _fEntry.x[1], 2.350000000000000088817841970012523233890533447265625 );
				fDst.x[2] = std::pow( _fEntry.x[2], 2.350000000000000088817841970012523233890533447265625 );
				break;
			}
			case LSN_G_POW_2_4 : {
				fDst.x[0] = std::pow( _fEntry.x[0], 2.399999999999999911182158029987476766109466552734375 );
				fDst.x[1] = std::pow( _fEntry.x[1], 2.399999999999999911182158029987476766109466552734375 );
				fDst.x[2] = std::pow( _fEntry.x[2], 2.399999999999999911182158029987476766109466552734375 );
				break;
			}
			case LSN_G_POW_2_5 : {
			...
			case LSN_G_POW_2_7 : {
				fDst.x[0] = std::pow( _fEntry.x[0], 2.70000000000000017763568394002504646778106689453125 );
				fDst.x[1] = std::pow( _fEntry.x[1], 2.70000000000000017763568394002504646778106689453125 );
				fDst.x[2] = std::pow( _fEntry.x[2], 2.70000000000000017763568394002504646778106689453125 );
				break;
			}
			case LSN_G_POW_2_8 : {
				fDst.x[0] = std::pow( _fEntry.x[0], 2.79999999999999982236431605997495353221893310546875 );
				fDst.x[1] = std::pow( _fEntry.x[1], 2.79999999999999982236431605997495353221893310546875 );
				fDst.x[2] = std::pow( _fEntry.x[2], 2.79999999999999982236431605997495353221893310546875 );
				break;
			}
		}
		...
		switch ( _gMonitorGamma ) {
			...
			case LSN_G_POW_1_96 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.51020408163265307255329616964445449411869049072265625 );	// 1.0 / 1.96
				fDst.x[1] = std::pow( fDst.x[1], 0.51020408163265307255329616964445449411869049072265625 );	// 1.0 / 1.96
				fDst.x[2] = std::pow( fDst.x[2], 0.51020408163265307255329616964445449411869049072265625 );	// 1.0 / 1.96
				break;
			}
			case LSN_G_POW_2_0 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.5 );	// 1.0 / 2.0
				fDst.x[1] = std::pow( fDst.x[1], 0.5 );	// 1.0 / 2.0
				fDst.x[2] = std::pow( fDst.x[2], 0.5 );	// 1.0 / 2.0
				break;
			}
			case LSN_G_POW_2_2 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.450000000000000011102230246251565404236316680908203125 );
				fDst.x[1] = std::pow( fDst.x[1], 0.450000000000000011102230246251565404236316680908203125 );
				fDst.x[2] = std::pow( fDst.x[2], 0.450000000000000011102230246251565404236316680908203125 );
				break;
			}
			case LSN_G_POW_2_35 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.425531914893617024819860716888797469437122344970703125 );	// 1.0 / 2.35
				fDst.x[1] = std::pow( fDst.x[1], 0.425531914893617024819860716888797469437122344970703125 );	// 1.0 / 2.35
				fDst.x[2] = std::pow( fDst.x[2], 0.425531914893617024819860716888797469437122344970703125 );	// 1.0 / 2.35
				break;
			}
			case LSN_G_POW_2_4 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.416666666666666685170383743752609007060527801513671875 );	// 1.0 / 2.4
				fDst.x[1] = std::pow( fDst.x[1], 0.416666666666666685170383743752609007060527801513671875 );	// 1.0 / 2.4
				fDst.x[2] = std::pow( fDst.x[2], 0.416666666666666685170383743752609007060527801513671875 );	// 1.0 / 2.4
				break;
			}
			case LSN_G_POW_2_5 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.40000000000000002220446049250313080847263336181640625 );	// 1.0 / 2.5
				fDst.x[1] = std::pow( fDst.x[1], 0.40000000000000002220446049250313080847263336181640625 );	// 1.0 / 2.5
				fDst.x[2] = std::pow( fDst.x[2], 0.40000000000000002220446049250313080847263336181640625 );	// 1.0 / 2.5
				break;
			}
			case LSN_G_POW_2_7 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.37037037037037034981068472916376776993274688720703125 );	// 1.0 / 2.7
				fDst.x[1] = std::pow( fDst.x[1], 0.37037037037037034981068472916376776993274688720703125 );	// 1.0 / 2.7
				fDst.x[2] = std::pow( fDst.x[2], 0.37037037037037034981068472916376776993274688720703125 );	// 1.0 / 2.7
				break;
			}
			case LSN_G_POW_2_8 : {
				fDst.x[0] = std::pow( fDst.x[0], 0.357142857142857150787307318751118145883083343505859375 );	// 1.0 / 2.8
				fDst.x[1] = std::pow( fDst.x[1], 0.357142857142857150787307318751118145883083343505859375 );	// 1.0 / 2.8
				fDst.x[2] = std::pow( fDst.x[2], 0.357142857142857150787307318751118145883083343505859375 );	// 1.0 / 2.8
				break;
			}
		}
