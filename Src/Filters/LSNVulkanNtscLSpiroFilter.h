...
namespace lsn {
	...
	/**
	 * Class CVulkanNtscLSpiroFilter
	 * \brief My own implementation of an NTSC filter for Vulkan 1.0.
	 *
	 * Description: My own implementation of an NTSC filter.
	 */
	class CVulkanNtscLSpiroFilter : public CLSpiroNtscFilterBase, public CVulkanFilterBase {
	public :
		CVulkanNtscLSpiroFilter();
		virtual ~CVulkanNtscLSpiroFilter();
