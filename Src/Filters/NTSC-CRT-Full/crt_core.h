 ...
 */
extern void crt_init_full(struct CRT *v, int w, int h, int f, unsigned char *out);
 ...
 *   out - pointer to output image data
 */
extern void crt_resize_full(struct CRT *v, int w, int h, int f, unsigned char *out);
