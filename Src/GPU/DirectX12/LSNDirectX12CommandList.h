...
namespace lsn {
	...
	/**
	 * Class CDirectX12CommandList
	 * \brief A Direct3D 12 command list.
	 *
	 * Description: A Direct3D 12 command list.
	 */
	class CDirectX12CommandList {
	public :
		 ...
		 **/
		inline ID3D12CommandList *								Get() { return m_pclList; }


	protected :
		// == Members.
		/** The command list we wrap. */
		ID3D12CommandList *										m_pclList = nullptr;
	};
