...
namespace lsn {
	...
	LSN_AUDIO_PROFILE LSN_AUDIO_OPTIONS::s_apProfiles[] = {
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N1151667 ),				39364.503906f,	100.0f,			20.0f,		20.0f,		0.360f,		1.0f,		1.0f,		1.0f,		1.0f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true },
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N8869725 ),				26243.0f,		125.9664f,		20.0f,		20.0f,		0.446f,		1.0f,		1.0f,		1.0f,		1.0f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true },
