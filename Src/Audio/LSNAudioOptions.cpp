...
namespace lsn {
	...
	LSN_AUDIO_PROFILE LSN_AUDIO_OPTIONS::s_apProfiles[] = {
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N20914398 ),				0.0f,			224.20062289111536f,		125.06316358912643f,		51.287540390847823f,	4.525f,		1.0f,		1.0f,		0.924f,		0.906f,		1.0f,		LSN_FM_NORMAL,	false,		true,		true,		true,		false,	true,	false },	// 4.52856215666421402232799664488993585109710693359375
