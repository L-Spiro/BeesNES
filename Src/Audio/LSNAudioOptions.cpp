...
namespace lsn {
	...
	LSN_AUDIO_PROFILE LSN_AUDIO_OPTIONS::s_apProfiles[] = {
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N34169630 ),				17000.0f,		310.0f,			67.0f,		7.5f,		0.395f,		1.0f,		1.0f,		1.0f,		0.934f,		1.0f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true },
		...
		/*7872.899902f*/
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_TWIN_FAMI_475711 ),				7000.0f,		200.0f,			34.5f,		34.5f,		0.402f,		0.938f,		0.938f,		1.0f,		0.869f,		1.0f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true },
