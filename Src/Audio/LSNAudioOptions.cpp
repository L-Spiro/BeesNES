...
namespace lsn {
	...
	LSN_AUDIO_PROFILE LSN_AUDIO_OPTIONS::s_apProfiles[] = {
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N1151667 ),				17000.0f,		91.670577848853171f,		37.490016890980982f,		7.9671720814703768f,	0.360f,		1.0f,		1.0f,		0.924f,		0.883f,		0.943f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true,	false,	 false },
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N34169630 ),				17000.0f,		285.17092929859564f,		85.509330674952423f,		7.3617262313390981f,	0.395f,		1.0f,		1.0f,		1.0f,		0.934f,		0.998f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true,	false,	 false },
		...
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_FL_N8869725_RCA ),			0.0f,			96.678039344736646f,		36.696956603852406f,		8.3012408410527119f,	0.344f,		1.0f,		1.0f,		0.892f,		0.855f,		0.924f,		LSN_FM_NORMAL,	false,		true,		true,		true,		true,	true,	false,	 false },

		{ LSN_LSTR( LSN_AUDIO_OPTIONS_NES_TL_NN101255729 ),				0.0f,			80.308463849114986f,		52.357757591613563f,		7.9206051188443904f,	0.957f,		1.0f,		1.0f,		0.731f,		0.693f,		0.744f,		LSN_FM_NORMAL,	false,		true,		true,		true,		true,	true,	false,	 false },
		/*7872.899902f*/
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_TWIN_FAMI_475711 ),				7000.0f,		172.03311180028109f,		38.037422049578915f,		38.037208628936021f,	0.402f,		0.938f,		0.938f,		1.0f,		0.869f,		0.929f,		LSN_FM_NORMAL,	true,		true,		true,		true,		true,	true,	false,	 false },
		{ LSN_LSTR( LSN_AUDIO_OPTIONS_TWIN_FAMI_475711_SCART ),			0.0f,			302.96765178343128f,		30.586358931812008f,		4.0903076481735425f,	0.735f,		0.975f,		1.0f,		0.841f,		0.827f,		0.896f,		LSN_FM_NORMAL,	false,		true,		true,		true,		true,	true,	false,	 false },
