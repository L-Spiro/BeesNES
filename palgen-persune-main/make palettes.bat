...
py palgen-persune.py --skip-plot --float-pal docs/example_palettes/2C02G_phs_aps_ela_applysrgb_NTSC-1953.fpal -aps 5 -ela 0.01429 -phs -5.0 -blp 0.053571429 -rfc "NTSC (1953)" -e --linear-light
py palgen-persune.py --skip-plot --float-pal docs/example_palettes/2C02G_phs_aps_ela_applysrgb_NTSC-J.fpal  -aps 5 -ela 0.01429 -phs -5.0 -rpr 0.618 0.350 -rpg 0.280 0.605 -rpb 0.152 0.063 -rpw 0.28314501 0.29711289 -e --linear-light
